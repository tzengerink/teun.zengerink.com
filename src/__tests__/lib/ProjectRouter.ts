...
const createMockRouter = () => new MockRouter() as any
...
describe('next', () => {
  describe('with statement', () => {
    test('it opens the first photo when viewing the statement', () => {
      ...
      const projectRouter = new ProjectRouter(mockRouter, projects[0])
      projectRouter.next()
      expect(mockRouter.pushed).toEqual(`/work/${projects[0].slug}/01`)
    })
    ...
    test('it opens the statement when viewing the last photo', () => {
      ...
      projectRouter.next()
      expect(mockRouter.pushed).toEqual(`/work/${projects[0].slug}`)
    })
    ...
    test('it opens the next photo', () => {
      ...
      projectRouter.next()
      expect(mockRouter.pushed).toEqual(`/work/${projects[0].slug}/03`)
    })
  })
