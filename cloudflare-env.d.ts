/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 8dd79ee87fb39a871e200685e5db7a46)
// Runtime types generated with workerd@1.20251125.0 2025-11-26 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_PROTO: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_PROTO" | "NEXT_PUBLIC_HOST">> {}
}
